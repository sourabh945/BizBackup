...
Paths = {'upload_bash':base+'/scripts/uploader.sh','upload_ps':base+'/scripts/uploader.ps1','download_bash':base+'/scripts/downloader.sh','download_ps':base+'/scripts/downloader.ps1'}
